				...
				<div class="col-lg-8">
					<div class="row text-center">
						<div class="col-lg-4 col-md-4 mb-5">
							<a href="../MenuServlet#breakfastSection"><img
								src="../images/breakfast.png" class="img-fluid" alt="Breakfast" /></a>
							<h6>Breakfast</h6>
						</div>
						<div class="col-lg-4 col-md-4 mb-5">
							<a href="../MenuServlet#lunchSection"> <img
								src="../images/lunch.png" class="img-fluid" alt="Lunch" />
							</a>
							<h6>Lunch</h6>
						</div>
						<div class="col-lg-4 col-md-4 mb-5">
							<a href="../MenuServlet#dinnerSection"><img
								src="../images/dinner.png" class="img-fluid" alt="Dinner" /></a>
							<h6>Dinner</h6>
						</div>
					</div>
				</div>
